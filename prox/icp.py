...
def dist_icp(src, dst, src_normal=None, standard_deviation_range=0.0, threshold=0.05):
...
def icp(A, B, standard_deviation_range = 0.0, init_pose=None, max_iterations=100, convergence=0.001, quickconverge=1, filename="results.txt"):
    ...
    for i in range(max_iterations):
        ...
        f.write("\n")
        for p in xrange(int(ceil(quickconverge))):
            src = np.dot(T, src)
    ...
    return T, distances, i# -*- coding: utf-8 -*-
